...
fun PrepScreen(
    ...
    LaunchedEffect(context) {
        runCatching { context.preloadCameraProvider() }
            .onFailure { Log.d("CameraWarmUp", "Camera provider warm-up skipped: ${it.message}") }
    }
...
private suspend fun Context.preloadCameraProvider(): ProcessCameraProvider = suspendCancellableCoroutine { continuation ->
